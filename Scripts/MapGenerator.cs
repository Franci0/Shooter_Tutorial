...
public class MapGenerator : MonoBehaviour
{
	...
	Queue<Coord> shuffledTilesCoord;
	Queue<Coord> shuffledOpenTilesCoord;
	Map currentMap;
	Transform[,] tileMap;
	...
	public void GenerateMap ()
	{
		...
		shuffledTilesCoord = new Queue<Coord> (Utility.ShuffleArray (allTilesCoords.ToArray (), currentMap.seed));
		...
		for (int i = 0; i < obstaclesCount; i++) {
			...
			if (randomCoord != currentMap.mapCenter && MapIsFullyAccessible (obstacleMap, currentObstacleCount)) {
				float obstacleHeight = Mathf.Lerp (currentMap.minimuObstacleHieight, currentMap.maximumObstacleHeight, (float)prng.NextDouble ());
		...
		shuffledOpenTilesCoord = new Queue<Coord> (Utility.ShuffleArray (allOpenCoords.ToArray (), currentMap.seed));
	...
	{
		Coord randomCoord = shuffledTilesCoord.Dequeue ();
		shuffledTilesCoord.Enqueue (randomCoord);
		return randomCoord;
	}

	public Transform GetRandomOpenTile ()
	{
		Coord randomCoord = shuffledOpenTilesCoord.Dequeue ();
	...
	public class Map
	{
		...
		public float minimuObstacleHieight;
